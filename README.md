...
This project contains two sections: the mods with which you can create and record game sequences and the scripts necessary to build the dataset. The former section was a readaptation of the [JTA-Mods](https://github.com/fabbrimatteo/JTA-Mods) by @fabbrimatteo while the latter was inspired by the [JTA-Dataset](https://github.com/fabbrimatteo/JTA-Dataset) by @fabbrimatteo. The original works focus on pedestrian pose estimation and tracking in urban scenario while this project concerns pedestrian re-identification.
***
